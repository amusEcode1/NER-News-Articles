...
def load_model(choice):
    if choice == "Small Model (with Rules)":
        ...
        nlp = spacy.load("/content/drive/MyDrive/Models/NER_News_Articles/rule_based_ner_sm")
        return nlp
    elif choice == "Medium Model (from SpaCy)":
        return spacy.load("en_core_web_md")
    else:
        # Load custom trained model
        return spacy.load("/content/drive/MyDrive/Models/NER_News_Articles/ner_conll_model")
